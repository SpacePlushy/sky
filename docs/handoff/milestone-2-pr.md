...
| Shadow transitions against an independent reference, 217 in a week | 16 ms (bounds 0.76 to 1.06 s) |
| Civil twilight against USNO's published times | All 8 on USNO's printed minute |
| Heavens-Above, same element set, 9 visible passes | Rise and set 0.3 to 0.9 s, peaks 1.1 s |
