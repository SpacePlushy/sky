...
the cache for 6 hours, and Sky never asks CelesTrak for the same data twice within 2 hours.
...
- **Pass predictions** match Skyfield's 25 passes over 7 days within the coarse finder's
  stated bounds.
